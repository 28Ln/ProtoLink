...
class SerialStudioPanel(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        title = QLabel("Serial Studio Controls")
        ...
        self.mode_combo.addItem("HEX", SerialSendEncoding.HEX)
        self.mode_combo.addItem("ASCII", SerialSendEncoding.ASCII)
        self.mode_combo.addItem("UTF-8", SerialSendEncoding.UTF8)
        self.mode_combo.currentIndexChanged.connect(self._on_mode_changed)

        self.line_ending_combo = QComboBox()
        self.line_ending_combo.addItem("None", SerialLineEnding.NONE)

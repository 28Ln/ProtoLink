...
def build_module_catalog() -> list[FeatureModule]:
    return [
        ...
        FeatureModule(
            ...
            milestone="M3",
            status=ModuleStatus.BOOTSTRAPPED,
            summary="Rule-based match, transform, and respond pipeline across transports, with baseline runtime wiring and a minimal management panel in place.",
            acceptance=(
        ...
        FeatureModule(
            ...
            area="Automation",
            milestone="M3",
            status=ModuleStatus.NEXT,
            summary="Script-driven workflows for timed tasks, channel bridges, and replay jobs, with the script host abstraction already registered at bootstrap.",
            acceptance=(
        ...
        FeatureModule(
            ...
            summary="Encoding, checksum, format conversion, and JSON helper tools.",
            acceptance=(
        ...
        FeatureModule(
            ...
            milestone="M4",
            status=ModuleStatus.PLANNED,
            summary="Windows-oriented local network helper workflows for field setup tasks.",
            acceptance=(

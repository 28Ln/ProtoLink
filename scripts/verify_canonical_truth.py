...
def main() -> int:
    ...
    _require_contains("README", readme, "native-installer-cutover-evidence.json")
    ...
    _require_contains("VALIDATION", validation, "cutover-evidence-file")
    ...
    _require_contains("RELEASE_CHECKLIST", release_checklist, "native-installer-cutover-evidence.json")
